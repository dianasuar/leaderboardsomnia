  ...
  return (
    <div
      ...
      className={cn(
        ...
        'before:content-[""] before:absolute before:top-1/2 before:left-1/2 before:block before:size-[140%] dark:before:[background:radial-gradient(ellipse_at_50%_55%,transparent_10%,black_50%)] before:[background:radial-gradient(ellipse_at_50%_55%,transparent_10%,black_50%)] before:[transform:translate3d(-50%,-50%,0)]',
    ...
    >
      ...
      />
      <div className="absolute top-0 left-0 z-[7] size-full
  [background:repeating-linear-gradient(transparent,transparent_1px,rgba(0,0,0,.6)_1px,rgba(0,0,0,.6)_2px)]
